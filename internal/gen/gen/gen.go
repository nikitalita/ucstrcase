...
var (
	...
	unicodeVersion = flag.String("unicode",
		getEnv("UNICODE_VERSION", "15.0.0"),
		"unicode version to use")
	cldrVersion = flag.String("cldr",
		getEnv("CLDR_VERSION", "32"),
		"cldr version to use")
)
...
const header = `// Code generated by running "go generate" in ucstrcase_gen/. DO NOT EDIT.
...
func localReadmeFile() (string, error) {
	...
	return filepath.Join(root, "DATA", "README"), nil
}
...
func getLocalDir() string {
	...
	if _, err := os.Stat(readme); err != nil {
		...
		if err := os.WriteFile(readme, []byte(readmeTxt), 0644); err != nil {
			log.Fatal(err)
		}
	}
	return dir
...
const readmeTxt = `Generated by ucstrcase_gen/gen/gen DO NOT EDIT.

This directory contains downloaded files used to generate the various tables
in the ucstrcase_gen/ package.
